...
class CameraView: UIView, UITextFieldDelegate {
    ...
    private func initControlView() {
        ...
        DDView.setContents(labelTxt: "攻击录制设备: ", cont: [
            ...
            "DD61-小米10至尊", "DD62-红米note9pro", "DD63-荣耀9Xpro", "DD64-oppoK7x", "DD65-vivoiqoozi", "DD66-魅族17pro", "DD67-iphone11", "DD68-大疆摄像头全景", "DD69-mac摄像头罗技C930C", "DD70-联想摄像头广角", "DD71-华为mate30pro", "DD72-OPPOreno3pro", "DD73-荣耀笔记本2020", "DD74-健德源摄像头-双目近红外", "DD75-华捷艾米", "DD76-奥比中光",
